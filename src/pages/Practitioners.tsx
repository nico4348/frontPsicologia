...
import { UserPlus, Briefcase, MapPin, Users } from 'lucide-react'
									...
									<div className="flex items-center space-x-4">
										...
										<div>
											...
											<p className="text-green-200">
												{practitioner?.tipo_documento}:{' '}
												{practitioner?.numero_documento}
											</p>
										</div>
									</div>
								</div>
